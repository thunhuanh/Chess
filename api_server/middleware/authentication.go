...
func loadEnvParameters() {
	Path_Private_Key = getStringEnvParameter(PATH_PRIVATE_KEY, "./api_server/infrastructure/private.pem")
	Path_Public_Key = getStringEnvParameter(PATH_PUBLIC_KEY, "./api_server/infrastructure/public.pem")
}
